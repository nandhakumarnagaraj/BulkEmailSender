...
public class EmailService implements IEmailService {
    ...
    @Async
    @Override
    public void sendBulkEmail(List<String> recipients, String subject, String bodyRequest, List<MultipartFile> attachments) {
        log.info("Starting bulk email send to {} recipients", recipients.size());

        for (String recipient : recipients) {
            try {
                sendSingleEmail(recipient, subject, bodyRequest, attachments);
    ...
    @Override
    public void sendSingleEmail(String recipient, String subject, String bodyContent, List<MultipartFile> attachments) {
        ...
        try {
            ...
            emailLog.setErrorMessage(e.getMessage());
            emailLogRepository.save(emailLog);
            log.error("Error sending email with attachment to {}", recipient, e);
        }
    }
